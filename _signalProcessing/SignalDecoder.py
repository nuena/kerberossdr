...
class numpytest(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "numpytest")
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.blocks_vector_source_x_0 = blocks.vector_source_c(IQSamples, False, 1, [])
...
def main(top_block_cls=numpytest, options=None):
